...
import com.smit.projects.stayGrid.strategy.PricingService;
import com.smit.projects.stayGrid.strategy.PricingStrategy;
...
//  @Scheduled(cron = "*/5 * * * * *") // Run this method every 5 minutes - refer - crontab.cronhub.io
    @Scheduled(cron = "0 0 * * * *")
